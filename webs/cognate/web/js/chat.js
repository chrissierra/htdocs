...
function inicio(){
    var tabs_superior=document.getElementsByClassName("tabs_superior");
  //  alert(location.pathname);

   if(location.pathname.search("index.php")>0){
    tabs_superior[0].classList.add("active");
   }else if(location.pathname.search("about.php")>0){
    tabs_superior[1].classList.add("active");
   }else if(location.pathname.search("contact.php")>0){
    tabs_superior[3].classList.add("active");
       }else if(location.pathname.search("servicios.php")>0){   
        tabs_superior[2].classList.add("active");
           }

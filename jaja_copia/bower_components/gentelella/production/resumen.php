...
$resultado = $db1->query("SELECT * from ingreso_empleados WHERE empresa='$user'");
...
<div class="col-md-12 col-sm-12 col-xs-12">
                ...
                y actualiza los cambios.
                   ...
                   // money_format('%.2n', $number);
                        ...
                        echo '<tr>
                          <td><a href="editar_trabajadores.php?id='.$row["id"].'" >'.$row["nombre"].'</a></td>
                          <td><a href="editar_trabajadores.php?id='.$row["id"].'" >'.$row["puesto"].'</a></td>
                          <td>'.$row["jefatura"].'</td>
                          <td>'.$row["edad"].'</td>
                          <td>'.$row["ingreso"].'</td>
